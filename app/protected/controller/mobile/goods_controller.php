...
class goods_controller extends general_controller
{
    public function action_index()
    {
        ...
        if($goods = $goods_model->find($condition))
        {
            ...
            //购买数量
            $sales_volume = $goods_model->get_goods_sales_volume($condition['goods_id']);
            $this->sales_volume = $sales_volume[0]['sales_volume'];
    ...
    public function action_bookorder()
    {
        $this->compiler('book_order.html');
    }
