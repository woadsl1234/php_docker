...
use app\model\admin_active_model;
use app\model\admin_model;
use app\model\request_error_model;
use app\model\setting_model;
...
class main_controller extends general_controller
{
        ...
        switch(request('step'))
        {
            ...
            case 'pending':
                ...
                (
                    ...
                    'aftersales' => $this->get_condition_count('refund_model', 'process = 1'),
                    'review' => $this->get_condition_count('goods_review_model', 'status = 0'),
                    'recycle' => $this->get_condition_count('instead_sell_apply_model', 'status = 1'),
            ...
            case 'sysinfo':
                ...
                (
                    ...
                    'rewrite_enable' => $GLOBALS['rewrite_enable'] == 1 ? '开启' : '关闭',
                );
    ...
    private function get_condition_count($model_name, $condition = null, $col = null)
    {
        ...
        $rs = $model->query($sql);
        return $rs[0]['count'] ? $rs[0]['count'] : 0;
    }
}