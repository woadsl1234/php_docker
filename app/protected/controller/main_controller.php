...
class main_controller extends general_controller
{
    public function action_index()
    {
        ...
        $this->newarrival = $vcache->goods_model('find_goods', array(array('newarrival' => 1, 'page' => 1)), $GLOBALS['cfg']['data_cache_lifetime']);
        
        $this->recommend = $vcache->goods_model('find_goods', array(array('recommend' => 1, 'page' => 1)), $GLOBALS['cfg']['data_cache_lifetime']);
        
        $this->bargain = $vcache->goods_model('find_goods', array(array('bargain' => 1, 'page' => 1)), $GLOBALS['cfg']['data_cache_lifetime']);
